...
<!-- AUTOGEN:manifest:wasm START (generated by `fluxrig gears doc wasm`; do not edit by hand) -->
...
Runs a sandboxed WebAssembly module (wazero) as a polyglot message transform.

**Ports**

| Port | Direction | Role | Summary |
|---|---|---|---|
| `in` | input | message | Message passed to the module. |
| `out` | output | message | Message the module returns. |

**Configuration**

| Field | Type | Required | Default | Description |
|---|---|---|---|---|
| `source` | string | yes | - | Path or URN of the .wasm module (e.g. file://... or a CAS urn). |
| `entrypoint` | string |  | - | Exported function to call per message. |
| `memory_limit_pages` | integer |  | - | Wasm linear-memory cap in 64KiB pages. |
<!-- AUTOGEN:manifest:wasm END -->
